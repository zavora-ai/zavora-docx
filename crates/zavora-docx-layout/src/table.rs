...
use zavora_docx_oxml::table::{CT_Tbl, CT_TblBorders, CT_TblGrid, ST_VerticalJc, VMerge};
...
fn layout_cell_content(
    content: &[zavora_docx_oxml::table::CellContent],
    available_width: f64,
    styles: &CT_Styles,
    input: &LayoutInput,
    fm: &mut FontManager,
...
mod tests {
    use super::*;
    use zavora_docx_oxml::table::{CT_TblGrid, CT_TblGridCol};
    ...
    fn nested_table_layout_dimensions() {
        ...
        let styles = zavora_docx_oxml::styles::CT_Styles::default();
        let input = crate::input::LayoutInput {
            document: zavora_docx_oxml::document::CT_Document {
                body: zavora_docx_oxml::document::CT_Body {
                    content: Vec::new(),
                    sect_pr: None,
                },
