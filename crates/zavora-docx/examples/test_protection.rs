...
fn main() {
    ...
    p.add_run("Document Protection Demo")
        .font("Arial")
        .size(18.0)
        .bold(true);
    ...
    let mut p = doc.add_paragraph("");
    p.add_run("To unprotect: Review > Restrict Editing > Stop Protection")
        .font("Arial")
        .size(11.0);
    ...
    doc.save("/Users/jameskaranja/Downloads/08_protection.docx")
        .unwrap();
