...
fn main() {
    ...
    p.add_run("zavora-docx Feature Showcase")
        .font("Arial")
        .size(22.0)
        .bold(true);
    ...
    // Feature 1: Footnotes
    let mut p = doc.add_paragraph("");
    p.add_run("1. Footnotes & Endnotes")
        .font("Arial")
        .size(14.0)
        .bold(true);
    ...
    let mut p = doc.add_paragraph("");
    p.add_run("This text has a footnote")
        .font("Arial")
        .size(11.0);
    p.add_run("").footnote_ref(fn1);
    p.add_run(" and this has an endnote")
        .font("Arial")
        .size(11.0);
    ...
    p.add_hyperlink_run("Zavora AI GitHub", Some(&rel), None)
        .color("0563C1")
        .underline(true);
    p.add_run(" | Internal link: ").font("Arial").size(11.0);
    p.add_hyperlink_run("Jump to Form Fields", None, Some("form_fields"))
        .color("0563C1")
        .underline(true);

    // Feature 3: Bookmarks
    let mut p = doc.add_paragraph("");
    p.add_run("3. Bookmarks")
        .font("Arial")
        .size(14.0)
        .bold(true);
    p.bookmark(10, "bookmarks_section");
    let mut p = doc.add_paragraph("");
    p.add_run("This section is bookmarked as 'bookmarks_section' for cross-referencing.")
        .font("Arial")
        .size(11.0);
    ...
    let mut p = doc.add_paragraph("");
    p.comment_start(1);
    p.add_run("This text has a review comment attached to it.")
        .font("Arial")
        .size(11.0);
    p.comment_end(1);
    ...
    let mut p = doc.add_paragraph("");
    p.add_run("5. Watermark")
        .font("Arial")
        .size(14.0)
        .bold(true);
    let mut p = doc.add_paragraph("");
    p.add_run("Look behind the text — there's a diagonal 'CONFIDENTIAL' watermark on every page.")
        .font("Arial")
        .size(11.0);

    // Feature 6: Track Changes
    let mut p = doc.add_paragraph("");
    p.add_run("6. Track Changes")
        .font("Arial")
        .size(14.0)
        .bold(true);
    let mut p = doc.add_paragraph("");
    p.add_run("Original text remains. ")
        .font("Arial")
        .size(11.0);
    ...
    let mut p = doc.add_paragraph("");
    p.add_run("8. Document Protection")
        .font("Arial")
        .size(14.0)
        .bold(true);
    let mut p = doc.add_paragraph("");
    ...
    doc.save("/Users/jameskaranja/Downloads/00_showcase_all_features.docx")
        .unwrap();
